...
urlpatterns = [
    ...
    path('posts/<slug:slug>/create_comment', views.create_comment, name='create_comment'),
    path('posts/comment/<int:pk>/', views.delete_comment, name='delete_comment'),
    path('posts/comment/update/<slug:slug>/<int:comment_id>/', views.update_comment, name='update_comment'),
